...
# the base is the number lowest, where the highest number is hinum.
...
proc show_stats {} {
    ...
    puts "\033c" ;# this line clears the console.

    puts "NAME: \"$player(name) the $player(class)\", LVL: $player(level)"
...
proc get_inventory {} {
    ...
    set inventory_len [llength $player(inv)]
    ...
    if {$inventory_len < 1} {
        ...
        for {set index 0} {$index < $inventory_len} {incr index} {
